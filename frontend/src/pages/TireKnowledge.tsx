...
const knowledgeArticles: KnowledgeArticle[] = [
  {
    ...
    summary:
      '輪胎是汽車安全行駛的關鍵組件，了解輪胎更換時機與影響其壽命的因素至關重要。本文將深入探討輪胎的使用年限、磨耗指標以及日常保養建議。',
  ...
  },
  {
    ...
    summary:
      '當輪胎不幸遭受穿刺損傷時，補胎成為許多車主的首選。然而，補胎後的輪胎究竟可以使用多久？本文將深入探討影響因素，確保行車安全。',
  ...
  },
  {
    ...
    summary:
      '輪胎補胎是確保行車安全的重要維護措施。選擇合適的補胎技術，能夠確保汽車輪胎補胎後的密封性與耐久度，延長輪胎的使用壽命。',
  ...
  },
  {
    ...
    summary:
      '輪胎是汽車與地面接觸的唯一部分，輪胎狀況會直接影響行車安全。了解輪胎磨平的原因、危險性能降低行車風險。',
  ...
  },
  {
    ...
    summary:
      '道路行駛時的輪胎噪音是車輛噪音的主要來源，因此，靜音輪胎應運而生。讓我們深入了解靜音輪胎的特性與應用。',
  ...
  },
  {
    ...
    summary:
      '輪胎的原料是決定輪胎性能與耐用度的關鍵因素。透過了解輪胎的原料有助於我們更深入認識輪胎的製造技術與品質標準。',
